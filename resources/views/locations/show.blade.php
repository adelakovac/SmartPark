...
<style>
    ...
    .spot-typ { font-size:11px; color:rgba(255,255,255,0.35); margin-bottom:10px; text-transform:uppercase; }
    ...
    .report-btn { width:100%; padding:6px 0; font-size:11px; background:transparent; border:0.5px solid rgba(255,255,255,0.06); color:rgba(255,255,255,0.3); border-radius:6px; cursor:pointer; margin-top:6px; font-family:inherit; transition:all 0.15s; }
